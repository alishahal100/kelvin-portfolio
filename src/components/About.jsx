...
const About = () => {
  ...
  return (
    <div id='about' className="flex justify-center items-center min-h-[60vh] w-screen bg-white px-20 ">
      <div
        ref={aboutRef}
        className={`${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        } transition duration-1000 ease-in-out transform w-screen  p-8 bg-white rounded-lg `}
      >
